...
export function RegisterRoutes(app: Router) {
  ...
  // ###########################################################################################################
  app.post(
    "/api/v1/users/all-profile",
    ...fetchMiddlewares<RequestHandler>(UserController),
    ...fetchMiddlewares<RequestHandler>(
      UserController.prototype.GetAllUserController
    ),

    async function UserController_GetAllUserController(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    async function UserController_GetCardById(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(UserController),
    ...fetchMiddlewares<RequestHandler>(
      UserController.prototype.UpdateUserController
    ),

    async function UserController_UpdateUserController(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(UserController),
    ...fetchMiddlewares<RequestHandler>(
      UserController.prototype.DeleteUserContrioller
    ),

    async function UserController_DeleteUserContrioller(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
