...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { CompanyController } from "./../../controller/usercontroller/company-Controller";
import type {
...
const models: TsoaRoute.Models = {
  ...
  ICompanyDocument: {
    ...
    properties: {
      ...
      contactPerson: { dataType: "string", required: true },
      numberOfEmployees: { dataType: "double", required: true },
      address: { dataType: "string", required: true },
      companyDescription: { dataType: "string", required: true },
...
export function RegisterRoutes(app: Router) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(CompanyController.prototype.Crate),

    async function CompanyController_Crate(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
